...
@section('content')
@include('public.partials.breadcrumb', ['attribute' => trans('public.search.title')])
            ...
            <div class="col-12">
                    ...
                    <div class="col">
                        ...
                        <div class="shop-top-bar">
                            ...
                            <div class="product-view-mode">
                                @if(count($search) > 0)
                                <h2><span>1 - {{count($search)}}</span><span> @lang('public.search.of') {{$search->total()}}</span> @lang('public.search.result') <span class="query">{{$query}}</span></h2>
                                @else
                ...
                <div class="row mt-30">
                    <div class="col">
                        ...
                        <ul class="pagination">
                    {{ $search->links('public.partials.pagination', ['paginator' => $search]) }}
                        </ul>
                    </div>
                </div>
