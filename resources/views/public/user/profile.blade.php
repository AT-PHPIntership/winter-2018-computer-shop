                                    ...
                                    <div class="tab-content profile-edit-tab-content">
                                        <div id="edit-basic" class="tab-pane in active">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <span class="input-icon input-icon-right">
                                                        <input type="text" id="form-field-website" value="{{!(Auth::user()->profile->address) ? old('address') : Auth::user()->profile->address}}" name='address'/>
                                            ...
                                            <div class="form-group">
                                                ...
                                                @else
                                                <div class="col-sm-8">
                                                    <p class="mt-4 text-danger">{{Auth::user()->name}} @lang('master.content.message.img')</p>
                                                </div>
                                                @endif
                                                <div class="col-sm-8">
                                                ...
                                                <div class="row table table-bordered">
                                                    <div class="col-xs-12 col-sm-2">
                                                        <div class="text-center">
                                                            <img class="thumbnail inline no-margin-bottom" alt="" src="storage/product/"
                                                            width='176.83 px'/>
                                                        </div>
                                                    </div>
