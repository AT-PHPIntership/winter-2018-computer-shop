...
<nav class="side-navbar">
    ...
    <ul class="list-unstyled">
        ...
        <li><a href="{{ route('promotions.index') }}"><i class="fa fa-gift"></i>@lang('master.sidebar.promotion')</a></li>
        <li><a href="{{ route('codes.index') }}"><i class="fa fa-code"></i>@lang('master.sidebar.code')</a></li>
        <li><a href="{{ route('accessories.index') }}"><i class="fa fa-paperclip"></i>@lang('master.sidebar.accessory')</a></li>
    </ul>
</nav> 