            ...
            @csrf
              <div class="form-group row">
                ...
                <div class="col-sm-12">
                  <select name="name" class="form-control mb-3">
                    ...
                    @foreach(config('constants.permissions') as $key => $permissions)
                        <option {{($permission->name == $permissions) ? 'selected' : ''}} value="{{$permissions}}">{{$permissions}}</option>
                    @endforeach
                  </select>
              ...
              <div class="form-group">
                ...
                <div class="col-lg-6">
                  ...
                  <div>
                    <input type="checkbox" value="{{$action}}" name="permission_action[]" {{(in_array($action, json_decode($permission->actions))) ? 'checked' : ''}}> 
