                ...
                <div class="card-body">
                    <form class="form-horizontal" method="POST" action="{{ route('codes.store') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input id="inputHorizontalWarning" type="number" name="amount" placeholder="Amount" class="form-control" value="{{ old('amount') }}" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <select name="order_month">
                                    ...
                                    @for($i = 1; $i <= 12; $i++) <option {{ old('order_month') == $i ? "selected" : "" }} value="{{ $i }}">{{ $i }}</option>
                                        @endfor
                                </select>
