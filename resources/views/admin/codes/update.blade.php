                ...
                <div class="card-body">
                    <form class="form-horizontal" method="POST" action="{{ route('codes.update', $code->id) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input id="inputHorizontalWarning" type="number" name="amount" placeholder="Amount" class="form-control" value="{{ old('amount') ? old('amount') : $code->amount }}" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <select name="order_month">
                                    ...
                                    @for($i = 1; $i <= 12; $i++) <option {{ old('order_month', $code->order_month) == $i ? "selected" : "" }} value="{{ $i }}">{{ $i }}</option>
                                        @endfor
                                </select>
